function event_say(e)
	...
	elseif(e.message:findi("velketor")) then
		e.self:Emote("screams, 'Sorcerer... in my mind.  Get out...'  Frekka wails in agony.");
	elseif(e.message:findi("help")) then
		e.self:Emote("screams, 'No one can help me!  Leave before they are in your head as well you fool!'  Frekka winces in pain.");
	end
end

function event_say(e)
	...
	elseif(e.message:findi("guild coin") or e.message:findi("kobold shaman") or e.message:findi("slay") or e.message:findi("powerful") or e.message:findi("greater kobold")) then
		if(e.other:GetFactionValue(e.self) >= 100) then -- requires amiably
			if(e.message:findi("guild coin")) then
...
function event_trade(e)
	...
	elseif(e.other:GetFaction(e.self) < 5 and item_lib.check_turn_in(e.self, e.trade, {item1 = 13883,item2 = 13883,item3 = 13883},0)) then -- requires amiably, 3x kobold shaman paw

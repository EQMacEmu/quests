function event_say(e)
	if(e.message:findi("hail")) then
		if(e.other:GetFactionValue(e.self) >= 0) then
			e.self:Say("Hello, " .. e.other:GetCleanName() .. " and welcome to our tavern. If you are looking for Verte he might be on a delivery, but I'm sure he will be right back.");
		else

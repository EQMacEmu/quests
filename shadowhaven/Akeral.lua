function event_say(e)
	if(e.message:findi("hail")) then
		if(e.other:GetFactionValue(e.self) >= 0) then
			e.self:Say("Hello, " .. e.other:GetCleanName() .. ". Our shop specializes in literature for different types of trade skills. If you have some information that you would like to share, please let me know.");
		else

...
function event_trade(e)
	...
	if(e.other:GetFaction(e.self) < 2 and item_lib.check_turn_in(e.self, e.trade, {item1 = 8908,item2 = 8911})) then -- Writ of Thunder and Silver Blade of Rot
		...
		e.other:QuestReward(e.self,0,0,0,0,8915,1000); -- Purified Silver Blade
	end

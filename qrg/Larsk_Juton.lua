...
function event_trade(e)
	...
	if(e.other:GetFactionValue(e.self) >= 100 and item_lib.check_turn_in(e.self, e.trade, {item1 = 13309})) then
		...
		e.other:QuestReward(e.self,math.random(5),math.random(5),math.random(5),0,math.random(2137,2172,9006,5033),20000); --items: Raw-Hide Skullcap, Large Raw-Hide Boots, Wooden Shield, Bronze Broad Sword

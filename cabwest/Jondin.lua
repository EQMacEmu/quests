...
function event_say(e)
	...
	elseif(e.message:findi("fern flowers")) then
		...
		e.other:SummonCursorItem(17025); -- Item: Fern Flower Pouch
...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 12442})) then
		...
		e.other:Faction(e.self,443,1); -- Faction: Brood of Kotiz
		e.other:Faction(e.self,441,1); -- Faction: Legion of Cabilis
		if(math.random(100) < 35) then
			e.other:QuestReward(e.self,0,0,0,0,12443); -- Item: Kromdul Toothpick
		end
	end
end

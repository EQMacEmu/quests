...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 12708, item2 = 12712, item3 = 12713},1,text1)) then --Test of the Lord (Greenmist Quest 7/8)
		...
		e.other:QuestReward(e.self,0,0,0,0,12714,2000)
		eq.depop_with_timer();
	end

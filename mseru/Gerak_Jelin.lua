function event_say(e)
	...
	elseif(e.message:findi("sister is worried")) then
	...
	elseif(e.message:findi("good news")) then
		e.self:Say("Yeah, it looks grim to anyone in this awful place. I wrote her this letter when I found out that I was being exiled, but did not get a chance to give it to her. If you want to risk it, you can take it to her. Make no mention it is from me. She is loyal to the city and would not want to be cast out because of me.");
		e.other:SummonCursorItem(6269);
	end
end

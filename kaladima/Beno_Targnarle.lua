function event_say(e)
	...
	elseif(e.message:findi("matter")) then
		if(e.other:GetFaction(e.self) < 5) then
			...
			e.other:SummonCursorItem(18935); -- Sealed Note
		elseif(e.other:GetFaction(e.self) == 5) then
			e.self:Say(prove);
		else
			e.self:Say(shifty);
...
function event_trade(e)
	...
	if(e.other:GetFactionValue(e.self) >= 100 and item_lib.check_turn_in(e.self, e.trade, {item1 = 13054, item2 = 13054, item3 = 13054, item4 = 13054},1,text)) then -- Giant Rat Pelt
		...
		e.other:QuestReward(e.self,0,math.random(5),0,0,0,eq.ChooseRandom(13036,1051,13003,13002,10015,13009),500);
	elseif((e.other:GetFaction(e.self) < 5) and (item_lib.check_turn_in(e.self, e.trade, {item1 = 13282}))) then -- Scrap Metal
		...
		e.other:QuestReward(e.self,math.random(5),0,0,0,13995,500); -- Knight (Card)

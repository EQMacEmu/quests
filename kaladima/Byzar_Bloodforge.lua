...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 13931, item2 = 13931, item3 = 13931, item4 = 13931})) then
		...
		e.other:Faction(e.self,312,5);   -- StormGuard better
		e.other:Faction(e.self,274,1);   -- KazonStormhammer better
	...
	elseif(e.other:GetFactionValue(e.self) >= -100 and item_lib.check_turn_in(e.self, e.trade, {item1 = 13741, item2 = 13740},1,text)) then
		...
		e.other:Faction(e.self,274,3);   -- KazonStormhammer better
		e.other:Faction(e.self,293,3);   -- MinersGuild249 better
		e.other:Faction(e.self,290,5);   -- MerchantsOfKaladim better
		e.other:Faction(e.self,232,-5);   -- CraknekWarriors worse

...
function event_trade(e)
	...
	if(e.other:GetFactionValue(e.self) >= 0 and item_lib.check_turn_in(e.self, e.trade, {item1 = 13849, item2 = 13849, gold = 4},1,text3)) then -- helm
		...
		e.other:Faction(e.self,312,2,0); -- Storm Guard
	...
	if(e.other:GetFactionValue(e.self) >= 100 and item_lib.check_turn_in(e.self, e.trade, {item1 = 13132, item2 = 13848, item3 = 13848, gold = 16},1,text1)) then -- boots
		e.self:Say("Very good! Let me see here. Thread the legs around like this and... There you go. Wear them with pride!");
		e.other:Faction(e.self,312,3,0); -- Storm Guard
		e.other:Faction(e.self,274,1,0); -- Kazon Stormhammer
		e.other:Faction(e.self,293,1,0); -- Miners Guild 249
		e.other:Faction(e.self,290,1,0); -- Merchants of Kaladim
		e.other:Faction(e.self,232,-1,0);	-- Craknek Warrior

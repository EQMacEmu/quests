...
function event_trade(e)
	...
	if(e.other:GetFactionValue(e.self) >= 100 and item_lib.check_turn_in(e.self, e.trade, {item1 = 12156, item2 = 5014},1,text)) then
		...
		e.other:Faction(e.self,312,15); -- Faction: Storm Guard

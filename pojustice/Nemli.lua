...
function event_say(e)
    if(e.language == 5 and e.other:GetLanguageSkill(5) >= 100) then
        if(e.message:findi("Hail")) then
            e.self:Say("Hail!'  He jumps up and extends you his hand.  'Well met, ".. e.other:GetName() .. "!  It's been a while since I saw a friendly face, here in all this gloom, I have to tell ye.'  His feet nearly leave the floor in his excitement.  'Do ye bring word from [Nammy]?",5);

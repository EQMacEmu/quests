function event_say(e)
	...
	elseif(e.message:findi("they")) then
		e.self:Say("Don't play dumb!  I knew that they would send killers, perhaps this means my [punishment] has ended.  Perhaps now I can know death?");
	elseif(e.message:findi("punishment")) then
		e.self:Emote("judges you warily. 'Hmm, you don't look much like one of their [killers].");
	elseif(e.message:findi("killers")) then
		e.self:Say("I won't say their name.  I was one of them, and I am still honor bound to secrecy.  Just know that on Norrath there are good reasons to fear the [shadows].");
	elseif(e.message:findi("shadows")) then
		e.self:Say("I was one of them, born and bred to be an assassin.  It was my life.  In our circle, failure is death, but [what I did] was worse than failure so I wasn't granted the release of the Eternal Slumber.");
    elseif(e.message:findi("what did you do")) then
        e.self:Say("I betrayed the sect.  I protected, still [protect], my love.  She failed an assignment, and in the infinite wisdom of the council they sent me to exact our justice on her. It was to be my final test, failure would mean death, as it does always, success would mean ascension to the council.  I knew that were I simply to fail, it would only be a matter of time before one of my brethren would be successful, then not only would my death be in vain, but I would see my love too soon in the afterworld.");

...
function event_say(e)
    if(e.language == 18 and e.other:GetLanguageSkill(18) >= 100) then
        if(e.message:findi("Hail")) then
            e.self:Say("A " .. e.other:Race() .. ", what a pleasant ssssurprise.  Here, of all placesss.  I wonder of which crime you are accusssed to bring you here, to the plane that watches all [planes]?");

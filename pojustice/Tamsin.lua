...
function event_say(e)
    if(e.language == 8 and e.other:GetLanguageSkill(8) >= 100) then
        if(e.message:findi("Hail")) then
            e.self:Say("Hail to thee, ".. e.other:GetName() .. ".  Sit with me, if ye please.  Were it only that I could offer ye a little more in the way of hospitality.  Tell me a little of Ak'anon, of my dear home; does it [prosper]?",8);
        ...
        elseif(e.message:findi("meet")) then
            e.self:Say("My studies, always my life had been my studies.  When searching the woods near to Ak'anon for blackroot, I met my love.  My love, all dressed in traveling garb and radiant as the sun; as like to me as white to black, as life to death itself.  Do ye believe in love at first sight, ".. e.other:GetName() .. "?  It takes your heart in its clasp and makes your soul its own, more binding than any ritual of raising or invocation of the dead.  Such was my love: nature walker, protector of the forest, servant of the Rainkeeper.  The effect upon my existence was that of a hurricane to a dandelion...  I was carried away and my [previous life] forgotten.",8);
        ...
        elseif(e.message:findi("end")) then
            e.self:Say("Cry not for me, ".. e.other:GetName() .. ".  I have lived and I have loved.  In this I am blessed.  I harbour no illusions that my time draws to an end, but my heart is [glad].",8);

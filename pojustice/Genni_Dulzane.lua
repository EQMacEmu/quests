...
function event_say(e)
    ...
    elseif(e.message:findi("crimes")) then
        e.self:Say("Our crimes are of the flesh.  Foolish, young, and to be paid for.  They are of little consequence now.  Much as everything, ye might say.  Little expected, our judgment was to be more swift than we had a right to expect, and from [improper hands].");
    elseif(e.message:findi("improper hands")) then
        e.self:Emote("dims slightly, then returns to sight.  'Improper indeed, for the door was burst open, and armed!  Armed he was!  Terrible and vicious, with anger and hatred - no justice, no judgment, unless 'twas the judgment of a [mortal]!'");

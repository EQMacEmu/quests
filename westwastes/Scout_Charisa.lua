...
function event_trade(e)
	...
	if(e.other:GetFactionValue(e.self) >= 100 and item_lib.check_turn_in(e.self, e.trade, {item1 = 29684}, 0)) then -- Broken Disk
	...
	elseif(e.other:GetFactionValue(e.self) >= 100 and item_lib.check_turn_in(e.self, e.trade, {item1 = 29685}, 0)) then -- Robe of Benevolence
	...
	elseif(e.other:GetFactionValue(e.self) >= 100 and item_lib.check_turn_in(e.self, e.trade, {item1 = 29686}, 0)) then -- Bracer of Benevolence
	...
	elseif(e.other:GetFactionValue(e.self) >= 100 and item_lib.check_turn_in(e.self, e.trade, {item1 = 29687}, 0)) then -- Talisman of Benevolence

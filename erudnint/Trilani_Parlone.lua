...
function event_trade(e)
	...
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 1597})) then -- Divinatory Concoction 
		...
		e.other:Faction(e.self,246,15,0); -- Faction: Faydarks Champions
		e.other:Faction(e.self,275,3,0); -- Faction: Keepers of the Art
		e.other:Faction(e.self,279,2,0); -- Faction: King Tearis Thex
		e.other:Faction(e.self,239,-3,0); -- Faction: The Dead

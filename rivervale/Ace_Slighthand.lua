...
function event_say(e)
	...
	elseif(e.other:GetFaction(e.self) < 5) then -- requires amiably
		if(e.message:findi("kevlin")) then
...
local item_lib = require("items");
	...
	if(e.other:GetFaction(e.self) < 5 and item_lib.check_turn_in(e.self, e.trade, {item1 = 13182})) then --Kevlin's Debt

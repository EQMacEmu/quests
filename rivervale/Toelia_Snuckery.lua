function event_say(e)
	...
	elseif(e.message:findi("dishwasher") or e.message:findi("chomper")) then
		if(e.other:GetFaction(e.self) < 5) then -- requires amiably
			if(e.message:findi("dishwasher")) then
...
function event_trade(e)
	...
	if(e.other:GetFaction(e.self) < 5 and item_lib.check_turn_in(e.self, e.trade, {item1 = 13785})) then -- requires amiably
	...
	elseif(e.other:GetFaction(e.self) < 5 and item_lib.check_turn_in(e.self, e.trade, {item1 = 13786})) then -- requires amiably

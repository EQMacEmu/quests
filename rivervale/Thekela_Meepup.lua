function event_say(e)
	if(eq.is_the_shadows_of_luclin_enabled()) then -- confirmed no hail dialogue pre luclin
		...
		elseif(e.message:findi("seek.* annal")) then
			e.self:Say("Please go to the maze of Beholder, otherwise known as the Gorge of King Xorbb and slay the Muddite Recordkeeper. After you have received the annal from him I will also need you to collect 3 Pristine Stingers. Before these annals were stolen I remember him saying I needed those 3 stingers for a special spell so please gather them for me. I hope to see you soon " .. e.other:GetCleanName() .. ".");
		end
	end
end

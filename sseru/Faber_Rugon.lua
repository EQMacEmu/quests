...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 31787,item2 = 31787})) then
		e.self:Say("Oh, this is a fine piece of armor I made for ya!");
		e.other:QuestReward(e.self,0,0,0,0,29879,10000);  
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 31788,item2 = 31788,item3 = 31966,item4 = 31966})) then
		e.self:Say("Oh, this is a fine piece of armor I made for ya!");
		e.other:QuestReward(e.self,0,0,0,0,29878,10000); 
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 31965,item2 = 31965})) then
		e.self:Say("Oh, this is a fine piece of armor I made for ya!");
		e.other:QuestReward(e.self,0,0,0,0,29876,10000); 
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 31968,item2 = 31968})) then
 		e.self:Say("Oh, this is a fine piece of armor I made for ya!");
		e.other:QuestReward(e.self,0,0,0,0,29880,10000); 
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 31967,item2 = 31967})) then
		e.self:Say("Oh, this is a fine piece of armor I made for ya!");
		e.other:QuestReward(e.self,0,0,0,0,29877,10000);
	end

...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 3876}, 0)) then
		e.self:Emote("touches the coin to the back of her hand and then looks up with a smile. 'Please take this back to it's source,' she says and nods. You feel the coin return to your hand. Your palm tingles slightly and then the sensation fades.");
		...
		e.other:QuestReward(e.self,0,0,0,0,3877);
	end

...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 12366})) then -- Never Stop Chopping
		...
		e.other:Faction(e.self,229,10,0); -- Coalition of Tradefolk
		...
		e.other:QuestReward(e.self,0,0,0,0,17984,15000); -- Bottle Crate
	...
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 12365})) then
		...
		e.other:Faction(e.self,336,25,0); -- Coalition of Tradefolk Underground
		e.other:Faction(e.self,229,25,0); -- Coalition of Tradefolk

function event_say(e)
	...
	elseif(e.message:findi("greave")) then
		e.self:Say("I can't begin to tell you how important pants are " .. e.other:GetCleanName() .. ". Any injuries to them could disable you from escaping should you need to and would surely perish due to this. To create your greaves material you will need to combine 4 Bricks of Crude Iron Ore, 1 Coyote Pelt, 1 Shadow Wolf Tibia, 1 Bottle and 1 Raw Bamboo in your assembly kit. Once you have created the proper material take it to a forge along with this mold to fashion your very own Truthbringers Greaves.");
		e.other:SummonCursorItem(22614); -- An Enchanted Greaves Mold
	...
	elseif(e.message:findi("boot")) then
		...
		e.other:SummonCursorItem(22612); -- An Enchanted Boots Mold
...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 9927,item2 = 9928,item3 = 9929,item4 = 9930})) then  -- Fefslans Bracer, Gnoosals Bracer, Walorinags Bracer, Eridals Bracer
		...
		e.other:QuestReward(e.self,0,0,0,0,9936,1000); -- Longsword of Marr
	end

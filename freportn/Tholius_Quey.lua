...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 18736})) then
		...
		e.other:Faction(e.self,362,100,0); -- priest of marr
		e.other:Faction(e.self,330,-10,0); -- freeport militia
		e.other:Faction(e.self,281,15,0); -- knight of truth
		e.other:QuestReward(e.self,0,0,0,0,13556,20); -- Item: White and Blue Tunic*
	end

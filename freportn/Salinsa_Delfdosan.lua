...
function event_say(e)
	...
	elseif(e.message:findi("young cleric of house marr")) then
		...
		e.other:SummonCursorItem(17259); --Gem Encrusted Mail Kit
...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 9931,item2 = 9932, item3 = 9932})) then -- A Torn Qeynos Newsletter and Pristine Scarab Eyes 2x
		...
		e.other:Faction(e.self,330,-3); -- Faction: The Freeport Militia
		e.other:Faction(e.self,362,5); -- Faction: Priests of Marr
		e.other:Faction(e.self,311,2); -- Faction: Steel Warriors
		e.other:QuestReward(e.self,0,0,0,0,9937,200); -- Mace of the Ordained
	end

function event_say(e)
	...
	elseif(e.message:findi("lottery")) then
		e.self:Say("The Highkeep Lottery is held every season.  The Casino Treasurer, Lynn, handles all ticket sales and information.  She can be found at the vault.");
...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 18935},0)) then -- Sealed Note
		...
		e.other:QuestReward(e.self,0,0,0,0,17927,1000); -- Cracked Emerald
	end

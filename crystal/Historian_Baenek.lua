...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 18237}, 0)) then
		...
		e.other:Faction(e.self,460,5); -- citizen of frostone
		e.other:QuestReward(e.self,0,0,0,0,0,1000);
		eq.spawn2(121015,0,0,-308,-151,-554,0); -- NPC: Ghost_of_Burdael
		eq.depop_with_timer();
	end

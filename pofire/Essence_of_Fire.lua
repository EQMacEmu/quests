...
function event_say(e)
	...
	if ( ClientCanFlag(e.other) and e.message:findi("hail") ) then
		...
		if ( not e.other:HasItem(29147) and not e.other:HasItem(29165) ) then -- Globe of Dancing Flame, Quintessence of Elements
			e.other:SummonCursorItem(29147); -- Item: Globe of Dancing Flame
			flags = flags + 1;
		end

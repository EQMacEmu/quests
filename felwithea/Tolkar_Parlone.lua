...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 5573})) then -- folded note
		...
		e.other:Faction(e.self,275,15,0); -- Keepers of the Art
		e.other:Faction(e.self,279,3,0); -- King Tearis Thex
		e.other:Faction(e.self,246,2,0); -- Faydark's Champions
		e.other:Faction(e.self,239,-3,0); -- The Dead
		e.other:QuestReward(e.self,0,0,0,0,1056); -- Faded Cloak
	end

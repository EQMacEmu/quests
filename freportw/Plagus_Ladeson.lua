function event_say(e)
	...
	if(e.message:findi("hail")) then
		e.self:Say("Greetings " .. e.other:GetCleanName() .. ", and welcome to the Bunker. Are you a [new warrior] or [veteran]?");
	...
	elseif(e.message:findi("in east karana")) then
		...
		e.other:SummonCursorItem(18934); -- A Sealed Letter ID- 18934 - 'LoveToMilea'
	elseif(fac < 5) then

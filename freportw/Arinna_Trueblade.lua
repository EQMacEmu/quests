function event_say(e)
	if(eq.is_the_shadows_of_luclin_enabled()) then
		...
		elseif(e.message:findi("ready to begin")) then
			...
			e.other:SummonCursorItem(17262); -- Steel Warriors Mail Kit
		...
		elseif(e.message:findi("armguards")) then
			...
			e.other:SummonCursorItem(22613); -- An Enchanted Armguard
...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 9919,item2 = 9918,item3 = 9923})) then -- Pristine Giant Scarab Leg, Lion Paw, Vial of Smoke
		...
		e.other:Faction(e.self,281,5); -- Knights of Truth
		e.other:QuestReward(e.self,0,0,0,0,9940,100); -- Jagged Blade of the Steel Warrior
	end

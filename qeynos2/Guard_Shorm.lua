function event_say(e)
	if(e.message:findi("hail")) then
		e.self:Say("What do you want with bothering Shorm? I have no time for the likes of you, " .. e.other:GetCleanName() .. "! Clear my path or meet my blade!");
	elseif(e.message:findi("gnoll")) then
		e.self:Say("Heh?  What would someone like you want to know about gnolls for?  You just leave them to us and mind your own business!");

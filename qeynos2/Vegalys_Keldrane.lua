...
function event_say(e)
	...
	elseif(e.message:findi("advance") and e.other:HasItem(18289) == true) then
	...
	elseif(e.message:findi("advance") and e.other:HasItem(2386) == true) then
	...
	elseif(e.message:findi("advance") and e.other:HasItem(2583) == true) then
...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 2173},0)) then -- Cracked Corrupt Guard Helm
		...
		e.other:QuestReward(e.self,0,0,0,0,18289,2000);
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 2386},0)) then -- Investigator's Badge
		...
		e.other:QuestReward(e.self,0,0,0,0,18292,2000);
	...
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 2694,item2 = 2392})) then -- Seal of Vegalys and Head of Azibelle Spavin
		...
		e.other:Faction(e.self,219,5); -- Antonius Bayle
		e.other:Faction(e.self,262,5); -- Guards of Qeynos
		e.other:Faction(e.self,304,-5); -- Ring of Scale
		e.other:Faction(e.self,273,-5); -- Kane Bayle
		e.other:Faction(e.self,291,5); -- Merchants of Qeynos

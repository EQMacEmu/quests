function event_say(e)
	...
	elseif(e.message:findi("magical item")) then
		...
		e.other:SummonCursorItem(17267); -- Item: Prime Healers Assembly Kit
	...
	elseif(e.message:findi("boot")) then
		e.self:Say("To create your boot material you will need to combine 3 Bricks of Crude of Iron Ore, 1 Severed Gnoll Foot,  2 King Snake Jawbones and 1 Large Myotis Bat Wing in your assembly kit. Once you have created the proper material take it to a forge along with this mold to fashion your very own Boot of the Prime Healer Initiate.");
	...
	elseif(e.message:findi("what delivery")) then
		...
		e.other:SummonCursorItem(27498); -- Item: Bag of Rations
	end
end

...
function event_waypoint_arrive(e)
	...
	if(e.wp == 10) then
		...
		eq.signal(2062,1); -- NPC: Tubal_Weaver
	elseif(e.wp == 18) then
		e.self:Say("Tubal doesn't suspect a thing.. the poor sap.");
		eq.signal(2063,3); -- NPC: Crow
	end

...
function event_say(e)
	...
	elseif(e.message:findi("cave")) then
		e.self:Say("Soes he learn me ta talk like da elves do. Took a few months but I learned it. I figgered it was worth all da effort since meez would have all da high elf meat meez could want after dat. After meez tink he did a good job at teachin me to talk like da udder elves, meez ate him. Want meez ta [show you how] dose elves talk over dere?");
	...
	elseif(e.message:findi("shop near kelethin")) then
		e.self:Say("Meez made a lot of money in dat little shop sellin da meat pies I made outta all da elves. Udders like da humies and dorfs started ta come to meez shop ta buy da meat pies too. Everybody loved da meat pies and thought day was good. So many peeples wer commin ta meez shop dat I had ta [step up production]. Troll cookin is da best cookin, course day thought meez was a high elf.");

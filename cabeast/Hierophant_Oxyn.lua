...
function event_say(e)
	...
	elseif(e.message:findi("temple tasks")) then
	...
	elseif(e.message:findi("daily tasks")) then
		if(e.other:GetFactionValue(e.self) >= 100) then
			...
			e.other:SummonCursorItem(17020); 								--give the player the combine box: Component Mortar
	...
	elseif(e.message:findi("iron cudgel")) then -- does boggle emote 170
	...
	elseif(e.message:findi("larger problem")) then
		if(e.other:GetFactionValue(e.self) >= 100) then
...
function event_trade(e)
	...
	if(e.other:GetFactionValue(e.self) >= 0 and item_lib.check_turn_in(e.self, e.trade, {item1 = 3895},0)) then 	--Crusaders of Greenmist (Greenmist Quest 8/8)
	...
	elseif(e.other:GetFactionValue(e.self) >= 0 and item_lib.check_turn_in(e.self, e.trade, {item1 = 3886},0)) then --Crusaders of Greenmist (Greenmist Quest 8/8)
	...
	elseif(e.other:GetFactionValue(e.self) >= 100 and item_lib.check_turn_in(e.self, e.trade, {item1 = 12403},0)) then --Full Component Mortar
	...
	elseif(e.other:GetFactionValue(e.self) >= 100 and item_lib.check_turn_in(e.self, e.trade, {item1 = 12721, item2 = 12722, item3 = 12723, item4 = 5140},1,text1)) then
	...
	elseif(e.other:GetFactionValue(e.self) >= 100 and item_lib.check_turn_in(e.self, e.trade, {item1 = 12724, item2 = 12725, item3 = 5141})) then

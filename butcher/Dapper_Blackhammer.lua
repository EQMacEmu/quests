function event_say(e)
	if(e.message:findi("hail")) then
		e.self:Say("Hello, " .. e.other:GetCleanName() .. ". What brings you to this neck of the mountains? Do you have any work for me?");
	end
...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 12880, item2 = 6552, platinum = 500})) then
		...
		e.other:QuestReward(e.self,{itemid = 6551, exp = 25000}); -- Item: Rozzuts Whistler
	end

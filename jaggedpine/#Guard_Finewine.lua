...
function event_trade(e)
	...
	if(e.other:GetFaction(e.self) < 5 and item_lib.check_turn_in(e.self, e.trade, {item1 = 8283}, 0)) then
	...
	elseif(e.other:GetFaction(e.self) < 5 and (item_lib.check_turn_in(e.self, e.trade, {item1 = 8199}, 0) or item_lib.check_turn_in(e.self, e.trade, {item1 = 8198}, 0))) then -- Dryad Pate or Potameid Pate
	...
	elseif(e.other:GetFaction(e.self) < 5 and item_lib.check_turn_in(e.self, e.trade, {item1 = 8278}, 0)) then -- Panther Pate

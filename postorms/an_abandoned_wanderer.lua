			...
			elseif(e.self:GetRace() == 12) then -- gnome
				...
				elseif(e.self:GetGender() == 1) then
					if(e.other:GetGender() == 0) then
						...
						e.self:Say("Well, look at you. You must think you're pretty special to be all the way in here trying to usurp my men! I'll have you know that I'm the best at what I do, and no little rat-faced, know-nothing is going to come between me and my men!");
					end
				end

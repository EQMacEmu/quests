function event_say(e)
	...
	elseif(e.message:findi("soil")) then
		if(e.other:GetFaction(e.self) > 3 ) then -- kindly or better to get quest.
...
function event_trade(e)
	...
	elseif(e.other:GetFaction(e.self) < 4 and item_lib.check_turn_in(e.self, e.trade, {item1 = 12106, item2 = 12106, item3 = 12106, item4 = 12106},1,text)) then  -- Fairy Dust need kindly as verified from live

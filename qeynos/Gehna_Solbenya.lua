function event_say(e)
	...
	elseif(e.message:findi("blessings to the flock") or e.message:findi("serve karana") or e.message:findi("hunt bandit binders")) then
		if(e.other:GetFaction(e.self) <= 4) then	-- requires amiably
			if(e.message:findi("serve karana")) then
...
function event_trade(e)
	...
	elseif(e.other:GetFaction(e.self) < 5 and item_lib.check_turn_in(e.self, e.trade, {item1 = 12101,item2 = 12101},1,text)) then -- spectacle

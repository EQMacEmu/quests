function event_say(e)
	...
	elseif(e.message:findi("confession")) then
		...
		e.other:SummonCursorItem(2344); -- Item: Confession Document
...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 18289})) then
		...
		eq.unique_spawn(1183,0,0,-324,200,6,120); -- NPC: #Riley_Shplots
	...
	elseif(item_lib.check_turn_in(e.self, e.trade,{item1 = 2369,item2 = 2394,item3 = 2279})) then
		...
		e.other:Faction(e.self,219,5,0); -- Faction: Antonius Bayle
		e.other:Faction(e.self,262,5,0); -- Faction: Guards of Qeynos
		e.other:Faction(e.self,304,-2,0); -- Faction: Ring of Scale
		e.other:Faction(e.self,273,-5,0); -- Faction: Kane Bayle

...
function event_trade(e)
	...
	elseif(e.other:GetFactionValue(e.self) >= -400 and item_lib.check_turn_in(e.self, e.trade, {item1 = 13396})) then -- Rat Kings Head -- confirmed faction with lower than -300, wouldn't give quest but accepted human head

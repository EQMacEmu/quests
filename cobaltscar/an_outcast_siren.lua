...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 25107}, 0)) then
		...
		e.other:QuestReward(e.self,0,0,0,0,25108,1000); -- Excellent Siren Scales, Idol of Solusek Ro (statless)
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 25108,item2 = 25109,item3 = 25109,item4 = 25109})) then

function event_say(e)
	...
	elseif(e.message:findi("important components")) then
		...
		e.other:SummonCursorItem(17256); -- Item: Tinkered Sewing Kit
	...
	elseif(e.message:findi("sandals")) then
		...
		e.other:SummonCursorItem(22585); -- Item: An Enchanted Sandals Pattern
...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 9116, item2 = 9117, item3 = 9118, item4 = 9119})) then
		...
		e.other:QuestReward(e.self,0,0,0,0,9120,25); -- Item: Spellbook of the Eldritch Initiate
	end

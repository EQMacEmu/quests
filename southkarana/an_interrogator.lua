...
function event_waypoint_arrive(e)
	if(e.wp == 1) then
		...
		eq.unique_spawn(14146,0,0,-2680,-5465,0,192); -- NPC: #Theodore_Exanthem
	elseif(e.wp == 2) then  -- a workaround for waypoint
		eq.signal(14146,6,5000); -- NPC: #Theodore_Exanthem
	elseif(e.wp == 3) then
		eq.unique_spawn(14147,0,0,-3287,-6040,0,28); -- NPC: #Morley_Murrain
		eq.unique_spawn(14127,0,0,-3280,-6050,0,31); -- NPC: #Markus_Cachexia
		eq.spawn2(14140,0,0,-3285,-6075,0,78); -- NPC: Skeletal_Servant
		eq.spawn2(14140,0,0,-3333,-6055,0,0); -- NPC: Skeletal_Servant
		eq.spawn2(14148,0,0,-3306,-6056,0,66); -- NPC: Ghoul

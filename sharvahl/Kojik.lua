function event_say(e)
	if(e.message:findi("Hail")) then
		e.self:Say("Greetings, adventurer. Perhaps you would like to purchase a container to help you carry your gear. Have a look at my wares and see if something catches your eye.");

function event_say(e)
	...
	elseif(e.message:findi("stout")) then
		e.self:Say("My personal favorite. It is customary for Vah Shir to drink this when they first come of age. It is a thick and hearty black stout. To some, this stout is a statement to all that they are ready to take on another year with honor and bravery. And so it has become the customary birthday brew.");
	...
	elseif(e.message:findi("gladiator")) then
		e.self:Say("Ahh, the Gladiator Choice Ale. It is the preferred drink during gladiatorial events held within the arena. This is the finest ale in all of Shar Vahl. The brewers have carefully selected a variety of hops and barley malts to bring you this smooth dark blend. It goes best with a hearty dinner.");
	elseif(e.message:findi("wine")) then
		e.self:Say("A creation of our shaman alchemists, this wine is imbued with magical properties. Tiny little air elements are focused into the wine during the fermentation process. It is then ritually blessed by a shaman over a period of a month. This produces everlasting tiny bubbles to tingle your palate when you consume this wondrous wine. A popular drink to court a kindred spirit, it is best shared with a loved one.");
	elseif(e.message:findi("rum")) then
		e.self:Say("A fine choice, the Royal Rebirth Rum is a recipe passed down within the Kerrath family. It is the only recipe remaining from before the time of the shifting. We have not yet found the ingredients to make more within this world, so supply is very limited. This rum is purchased to celebrate the grandest of events such as royal weddings.");
	elseif(e.message:findi("port")) then
		e.self:Say("Excellent eye. Our Select Celebration Port has been aged twenty years. It is the perfect drink to celebrate your weddings, victories, festivals, and birthdays. I highly recommend it, sir.");
	elseif(e.message:findi("liqueur")) then
		e.self:Say("We have fine liqueurs made from high quality cream and almonds. Our brewers and alchemists have worked diligently to bring these to perfection. They are quite popular, try them!");
	elseif(e.message:findi("whiskey")) then
		e.self:Say("These drinks are purchased to celebrate victory in battle. It is a toast to share the honor of the victory with the citizens of Shar Vahl. I hope one day I can drink a toast to your success, my friend.");

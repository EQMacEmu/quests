...
function event_timer(e)
	if(e.timer == "1") then
		...
		if(rand == 1) then
			e.self:Say("Don't waste those pelts, adventurer! Come buy a tailoring kit and weave yourself some armor!");
		end
		if(rand == 2) then
			e.self:Say("I have tailoring supplies! It's easy to learn. Come see!");
		end
		if(rand == 3) then
			e.self:Say("I have all sorts of patterns to make your tailoring easy. Come look at what I have to offer.");
		end
	end
end

function event_say(e)
	if(e.message:findi("Hail")) then
		e.self:Say("Hail Citizen. are you heading into the pit to practice?");
	elseif(e.message:findi("yes")) then
		e.self:Say("We were just down there, but climbed out to take a little break.  The creatures down there are really pounding some of the younger recruits.  If you're heading down, I'd suggest that you hop down and be prepared to fight.");
	elseif(e.message:findi("no")) then
		e.self:Say("Well, if you're looking to learn a little more about combat, you really should go sign in at the training camp.");

function event_say(e)
	if(e.message:findi("hail")) then
		e.self:Say("Very well met, " .. e.other:GetCleanName() .. ".  I do not remember seeing you here before.  Are you new to the Taruun?");
	elseif(e.message:findi("yes")) then
		e.self:Say("Well well new friend, welcome to our home!  It's a pleasant enough place to return to after a long scouting mission... but you'll learn about that soon enough.  There isn't much for you to do around here right now, so you should make your way out to the recruit training area.  It's not hard to spot.  Just walk out to the first bridge that you see, but do not cross it.  Work your way around the ledge until you find the camp to the west.  It was nice to meet you... take care!");
	elseif(e.message:findi("no")) then
		e.self:Say("Well, it doesn't surprise that I cannot remember a face at this point.  There are just so many new citizens running through here these days. Anyway... it was nice to meet you!  Please, let me know if you ever need anything.");

...
function event_timer(e)
	if(e.timer == "1") then
		...
		if(rand == 1) then
			e.self:Say("Come my friend, you will need light for those darkened caverns of the deepshade. I have torches and lanterns for sale.");
		end
		if(rand == 2) then
			e.self:Say("You with the sword! You look like you'll need some bandages to help you with your battle wounds. Come I will give you a good deal.");
		end
		if(rand == 3) then
			e.self:Say("You look thirsty. Come over here, I have fresh water for sale.");
		end
	end
end

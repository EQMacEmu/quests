function event_say(e)
	if(e.message:findi("Hail")) then
		e.self:Say("Greetings, come have a look at my quality footwear. They will protect you from sharp stones and nasty stinging bugs during your journeys.");
...
function event_timer(e)
	if(e.timer == "1") then
		...
		if(rand == 1) then
			e.self:Say("Come come! Have a look at my goods for sale. I will give you a good deal.");
		end
		if(rand == 2) then
			e.self:Say("Boots! Sandals! Quality footwear to help you walk the jagged trails. Come have a look!");
		end
		if(rand == 3) then
			e.self:Say("Come my friend, have a look at my goods. I have all sorts of footwear to chose from.");
		end
	end
end

...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 5550})) then
		...
		e.other:QuestReward(e.self,{items = {5550,17114}}); -- Item: Horn Covered Buckler
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 6217})) then
	...
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 6221})) then
		...
		e.other:Faction(e.self,1513,1); -- Faction: Guardians of Shar Vahl
		e.other:QuestReward(e.self,{items = {6141,6142,6148},exp = 1000}); -- Item: Blade Mold, Claw Mold
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 5557, item2 = 6158})) then
		e.self:Say("You have done well --name.  Wear this cloak with pride and enjoy the benefits of being a Khala Dun Journeyman.");
		e.other:QuestReward(e.self,{items = {6222,6158},exp = 10000}); -- Item: Cloak of the Khala Dun Journeyman
	end

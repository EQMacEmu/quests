function event_say(e)
	if(e.message:findi("hail")) then
		e.self:Say("Welcome to my tavern. Grab yerself an ale and have yerself a good time.  If you're lucky you'll catch one of our [shows].");
	elseif(e.message:findi("show")) then
		e.self:Say("We have regular performances by many talented travelers. Mostly passing traders from [Shadow Haven] who just want to have a good time.");
	elseif(e.message:findi("shadow haven")) then
		e.self:Say("A traders outpost within the heart of Luclin. The trade route runs through the Shadeweavers Thicket. You'd best be careful if you are planning on going through there.  There have been many [bandit] attacks.");
	elseif(e.message:findi("bandit")) then
		e.self:Say("They've been raiding the trade routes through the thickets for a while now. Times are tough lately. Brigands to the south and Grimlings to the north. You're pretty safe here in the city though. Our walls are sturdy and our Royal Khala Dun are the finest warriors I've laid eyes on. Enough chitchat, have yerself a drink.");

...
function event_say(e)
	...
	if(e.other:GetFaction(e.self) <= 3) then
		if(e.other:GetFactionValue(e.self) >= 400) then
			if(e.message:findi("continue what")) then --Part of Shaman Epic 1.0
		...
		if(e.other:GetFactionValue(e.self) >= 500) then
			...
			elseif(e.message:findi("how it all began")) then --Part of Shaman Epic 1.0
				...
				e.other:SummonCursorItem(17805); -- Item: Ancient Journal
			end
...
function event_trade(e)
	...
	if(e.other:GetFactionValue(e.self) >= 300 and item_lib.check_turn_in(e.self, e.trade, {item1 = 1668})) then --Part of Shaman Epic 1.0 Item: Sparkling Gem
	...
	elseif(e.other:GetFactionValue(e.self) >= 400 and item_lib.check_turn_in(e.self, e.trade, {item1 = 1672})) then --Part of Shaman Epic 1.0 Item: Black Dire Pelt
	...
	elseif(e.other:GetFactionValue(e.self) >= 500 and item_lib.check_turn_in(e.self, e.trade, {item1 = 3599})) then --Part of Shaman Epic 1.0 Item: Completed Report

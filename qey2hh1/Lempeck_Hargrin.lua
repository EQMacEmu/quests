...
function event_trade(e)
	...
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 13955})) then	-- Prime Healer Potion (Bad)
		...
		-- confirmed live factions
		e.other:Faction(e.self,341,10,0); -- Faction: Priests of Life
		e.other:Faction(e.self,280,3,0); -- Faction: Knights of Thunder
		e.other:Faction(e.self,262,5,0); -- Faction: Guards of Qeynos
		e.other:Faction(e.self,221,-2,0); -- Faction: Bloodsabers
		e.other:Faction(e.self,219,1,0); -- Faction: Antonius Bayle

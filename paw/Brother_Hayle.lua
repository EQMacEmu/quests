...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 18927})) then -- Temple Summons
		...
		e.other:Faction(e.self,341,20); 		-- Priest of Life
	...
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 18936})) then -- A Sealed Note
		...
		e.other:Faction(e.self,280,3); 		-- Knights of Thunder
		e.other:Faction(e.self,262,5); 		-- Guards of Qeynos
		e.other:Faction(e.self,221,-2); 		-- BloodSabers
		e.other:Faction(e.self,219,1); 		-- Antonious Bayle
	...
	elseif(item_lib.check_turn_in(e.self, e.trade, {item1 = 18937,item2 = 13947,item3 = 18828,item4 = 12197},1,text)) then -- A Note, Brilliant Sword of Faith, Testimony, Glowing Sword Hilt
		if(e.other:GetFactionValue(e.self) >= 750) then -- items will get eaten if faction not high enough.
			...
			e.other:Faction(e.self,280,30); 		-- Knights of Thunder

...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.self, e.trade, {item1 = 13985})) then -- Ruby Pendant, from Kurrpok
		...
		e.other:Faction(e.self,304,20); 		-- Ring of Scale
		e.other:Faction(e.self,284,-10); 		-- League of Antonican Bards	
		e.other:Faction(e.self,285,-5); 		-- Mayong Mistmoore
		e.other:Faction(e.self,315,-2); 		-- Trakanon
